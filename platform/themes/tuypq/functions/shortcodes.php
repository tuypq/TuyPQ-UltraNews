    ...
    if (is_plugin_active('blog')) {
        ...
        add_shortcode(
            ...
            function ($shortcode) {
                ...
                $rightCategoryIds = explode(',', $shortcode->right_categories_ids);
                $categoriesData = [];
                $rightCategoriesData = [];
                ...
                foreach ($rightCategoryIds as $categoryId) {
                    $category = get_category_by_id($categoryId);
                    if (! empty($category)) {
                        $rightCategoriesData[] = [
                            'category' => $category,
                ...
                return Theme::partial('shortcodes.categories-tab-posts', [
                    ...
                    'rightCategoriesData' => $rightCategoriesData,
                ]);
            }
        );
        ...
        add_shortcode(
            ...
            __('Categories list featured'),
            __('Add Categories list featured'),
            function ($shortcode) {

                $category = $list = get_categories(['condition' => ['is_featured'=>1]]);
                
                return Theme::partial('shortcodes.categories-list-featured', [
                    'shortcode' => $shortcode,
